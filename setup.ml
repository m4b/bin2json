...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8f52a4a4a575ffe01eb03542e02a3d57) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("test/test.sh", []))];
     ...
     package =
       {
          ...
          authors = ["m4b"];
          homepage = Some "http://github.com/m4b/bin2json";
          synopsis =
            "Converts an ELF, mach-o, or PE binary to a JSON representation";
          description =
            Some
              [
                 OASISText.Para
                   "This program converts an ELF, mach-o, or PE binary to a JSON representation using rdr as the backend.  Optionally minifies, converts the binary to a base64 representation, and/or includes the byte coverage analysis generated by rdr."
              ];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["B2J_Json"; "B2J_ByteCoverage"; "B2J_Config"];
                      lib_pack = false;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "json";
                           FindlibPackage ("base64", None);
                           FindlibPackage ("rdr", None);
                           FindlibPackage ("rdr.mach", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "json";
                           InternalLibrary "mach2json";
                           InternalLibrary "elf2json";
                           InternalLibrary "pe2json";
                           FindlibPackage ("base64", None);
                           FindlibPackage ("rdr", None);
                           FindlibPackage ("rdr.elf", None);
                           FindlibPackage ("rdr.mach", None);
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "bin2json.ml"});
               Test
                 ({
                     cs_name = "test_other";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "(\000\134\020d&\152\146éP\148\t\151Ú:d";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
